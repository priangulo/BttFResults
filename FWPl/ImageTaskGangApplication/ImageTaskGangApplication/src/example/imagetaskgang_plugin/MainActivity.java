...
public class MainActivity extends Activity {
     ...
     */
    private final example.imagetaskgang_framework.Filter[] mFilters = {
        new NullFilter(),
        new GrayScaleFilter()
    };
    ...
    public void runWithDefaultURLs(View view) {
        new Thread(new ImageTaskGang(mFilters,
                                     PlatformStrategy.instance().getUrlIterator(PlatformStrategy.InputSource.DEFAULT),
        ...
        Intent resultsIntent =
            new Intent(this,
                       ResultsActivity.class);
                               ...
                               resultsIntent.putExtra(FILTER_EXTRA, filterNames);
    ...
    @SuppressLint("InflateParams")
        ...
        AutoCompleteTextView newList = 
            ...
            LayoutInflater.from(this).inflate(R.layout.list_item, null);
    ...
    public void runWithUserURLs(View view) {
    	if (mRunButton.getVisibility() == View.VISIBLE) {
            Iterator<List<URL>> iterator =
                PlatformStrategy.instance().getUrlIterator(PlatformStrategy.InputSource.USER);
    ...
    public void clearFilterDirectories(View view) {
        new AsyncTask<example.imagetaskgang_framework.Filter[], Void, Void>() {
            protected void onPreExecute() {
                setButtonsEnabled(false);
            }

            protected Void doInBackground(example.imagetaskgang_framework.Filter[] ...filters) {
                for (example.imagetaskgang_framework.Filter filter : filters[0]) 
