...
public class ResultsActivity extends Activity {
    ...
    private void addResultButton(String filterName) {
        ...
        Button resultButton = 
             ...
             (Button) LayoutInflater.from(this).inflate(R.layout.result_button, null);
        ...
        resultButton.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    imageAdapter.setBitmaps(new File(PlatformStrategy.instance().getDirectoryPath(),
    ...
    public class ImageAdapter extends BaseAdapter {
        ...
        private void setBitmaps(String filterPath) {
            ...
            for (File bitmap : bitmaps){
                if (bitmap != null) {
                    mBitmaps.add(BitmapFactory.decodeFile(bitmap.getAbsolutePath()));
                }
            }
