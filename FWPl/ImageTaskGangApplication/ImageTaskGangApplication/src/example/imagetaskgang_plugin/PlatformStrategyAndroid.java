 ...
 */
public class PlatformStrategyAndroid extends example.imagetaskgang_plugin.PlatformStrategy {
    /** 
     ...
     */
    public example.imagetaskgang_framework.Image makeImage(byte[] imageData){
        return new example.imagetaskgang_framework.BitmapImage(imageData);
    }
    ...
    public ImageEntity grayScaleFilter(ImageEntity imageEntity) {
        example.imagetaskgang_framework.Image imageAdapter =
            ((ImageEntity) imageEntity).getImage();
        Bitmap originalImage =
            ((example.imagetaskgang_framework.BitmapImage) imageAdapter).mBitmap;
        ...
        example.imagetaskgang_framework.BitmapImage bitmapImage =
            new example.imagetaskgang_framework.BitmapImage(grayScaleImage);
     ...
     */
    public void storeImage(example.imagetaskgang_framework.Image imageAdapter,
                           FileOutputStream outputFile) {
    	
                                                      
                                                      ((example.imagetaskgang_framework.BitmapImage) imageAdapter).mBitmap.compress(Bitmap.CompressFormat.PNG, 100, outputFile);
    }
