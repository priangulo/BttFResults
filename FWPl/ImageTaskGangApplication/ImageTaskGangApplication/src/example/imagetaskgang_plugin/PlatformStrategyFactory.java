    ...
    public PlatformStrategyFactory(final Object output) {
        if (mPlatformType == PlatformType.ANDROID)
             ...
             */
                                     ...
                                     mPlatformStrategyMap.put(PlatformType.ANDROID, new IPlatformStrategyFactoryCommand() {
                  ...
                  */
                                          ...
                                          mPlatformStrategyMap.put(PlatformType.PLAIN_JAVA, new IPlatformStrategyFactoryCommand() {
