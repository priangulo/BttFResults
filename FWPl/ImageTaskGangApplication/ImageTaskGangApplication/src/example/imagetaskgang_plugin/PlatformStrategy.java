...
public abstract class PlatformStrategy {
     ...
     */
    public abstract example.imagetaskgang_framework.Image makeImage(byte[] imageData);
     ...
     */
    public abstract void storeImage(example.imagetaskgang_framework.Image image,
