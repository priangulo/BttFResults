...
public class MainConsole {
    ...
    public static void main(String[] args) {
        ...
        final example.imagetaskgang_framework.Filter[] filters = {
            new NullFilter(),
            new GrayScaleFilter()
        };
        ...
        PlatformStrategy.instance(new PlatformStrategyFactory
             (System.out).makePlatformStrategy());
                                             ...
                                             PlatformStrategy.instance().errorLog("MainConsole", "Starting ImageTaskGangTest");
        ...
        Iterator<List<URL>> urlIterator = 
            PlatformStrategy.instance().getUrlIterator(PlatformStrategy.instance().getInputSource(Options.instance().getInputSource()));
        ...
        try {
            ...
            mExitBarrier.await();
                                                 ...
                                                 PlatformStrategy.instance().errorLog("MainConsole", "await interrupted");
        }

         
                                             PlatformStrategy.instance().errorLog("MainConsole", "Ending ImageTaskGangTest");
    }
}