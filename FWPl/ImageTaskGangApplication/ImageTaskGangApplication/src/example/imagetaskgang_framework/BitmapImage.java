...
import android.graphics.BitmapFactory; public
 ...
 */
class BitmapImage implements example.imagetaskgang_framework.Image {
    /**
    ...
    public BitmapImage(byte[] imageData) {
                                                   ...
                                                   mBitmap = decodeSampledBitmapFromByteArray(imageData, IMAGE_WIDTH, IMAGE_HEIGHT);
    }
