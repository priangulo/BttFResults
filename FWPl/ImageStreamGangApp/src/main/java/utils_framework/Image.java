...
public class Image {
     ...
     */
     static final public int IMAGE_WIDTH = 250;
     static final public int IMAGE_HEIGHT = 250;
     ...
     */
    public void setFilterName(filters_framework.Filter filter) {
    ...
    public String getFileName() {
        return utils_framework.NetUtils.getFileNameForUrl(mSourceUrl);
    }
