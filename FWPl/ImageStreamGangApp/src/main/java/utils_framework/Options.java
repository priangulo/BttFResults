...
import utils_framework.ExceptionUtils.Function_WithExceptions;
...
public class Options {
    /** The singleton @a Options instance. */
     static public utils_framework.Options mUniqueInstance = null;
     ...
     */
     final public String[] mDefaultUrls = new String[] {        
     ...
     */
     public String mPathname = "defaultUrls.txt";
     ...
     */
    public static utils_framework.Options instance() {
        if (mUniqueInstance == null)
            mUniqueInstance = new utils_framework.Options();
    ...
    protected List<List<URL>> getDefaultUrlList()
          ...
          for (String suggestedUrls : mDefaultUrls)
            variableNumberOfInputURLs.add(convertStringToUrls(suggestedUrls));
...
//                     .collect(toList());
     ...
     * that's returned.
     */
     public List<URL> convertStringToUrls(String stringOfUrls) {
    	
    	utils_framework.ExceptionUtils.Function_WithExceptions<String,URL> func = null;
    	
        // Create a Function that returns a new URL object when
        // applied.
        Function<String, URL> urlFactory = utils_framework.ExceptionUtils.rethrowFunction(func);
