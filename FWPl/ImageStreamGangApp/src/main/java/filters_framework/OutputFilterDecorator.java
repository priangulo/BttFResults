 ...
 */
public class OutputFilterDecorator extends filters_framework.FilterDecorator {
    /**
     ...
     * template method.
     */
    public OutputFilterDecorator(filters_framework.Filter filter) {
    	super(filter);
    }
     ...
     */
    @Override
    protected utils_framework.Image decorate(utils_framework.Image image) {
