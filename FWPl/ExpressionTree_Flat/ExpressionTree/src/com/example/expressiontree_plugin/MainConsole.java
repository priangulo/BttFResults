...
public class MainConsole {
    ...
    public static void main(String[] args) {
         ...
         * CommandLinePlatform.
         */
        com.example.expressiontree_framework.Platform.instance(new PlatformFactory(System.in,
                                               System.out,
                                               null).makePlatform());
        ...
        if (Options.instance().verbose())
            ...
            com.example.expressiontree_framework.Platform.instance().outputString("Welcome!\n");
         ...
         */
                                                ...
                                                InputDispatcher.instance().makeHandler(Options.instance().verbose(), System.in, System.out, null);
