 ...
 */
public class PostOrderIterator implements Iterator<com.example.expressiontree_framework.ExpressionTree> {
    /** Stack of expression trees. */
     public Stack <com.example.expressiontree_framework.ExpressionTree> stack = new Stack<com.example.expressiontree_framework.ExpressionTree>();
	
    /** Ctor */
    public PostOrderIterator(com.example.expressiontree_framework.ExpressionTree tree) {
        if(!tree.isNull()) {
            stack.push(tree);
