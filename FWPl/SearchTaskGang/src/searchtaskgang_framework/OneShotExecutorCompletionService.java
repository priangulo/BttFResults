 ...
 */
public class OneShotExecutorCompletionService extends searchtaskgang_framework.SearchTaskGangCommon {
    /**
     * Processes the results of Futures returned from the
     * Executor.submit() method.
     */
    protected ExecutorCompletionService<searchtaskgang_framework.SearchResults> mCompletionService;
     ...
     */
     public OneShotExecutorCompletionService(String[] wordsToFind,
        ...
        mCompletionService =
            new ExecutorCompletionService<searchtaskgang_framework.SearchResults>(getExecutor());
    }
    ...
    protected boolean processInput(final String inputData) {
        ...
        for (final String word : mWordsToFind) {
            ...
            // processing.
                                             ...
                                             mCompletionService.submit(new Callable<searchtaskgang_framework.SearchResults>() {
                    @Override
