 ...
 */
public abstract class SearchTaskGangCommon extends searchtaskgang_framework.TaskGang<String> {
    /**
     ...
     */
     final public Iterator<String[]> mInputIterator;

    /**
     * Constructor initializes the data members.
     */
     public SearchTaskGangCommon(String[] wordsToFind,
     ...
     * any).
     */
    protected searchtaskgang_framework.SearchResults searchForWord(String word, 
                                          String inputData) {
        searchtaskgang_framework.SearchResults results =
            new searchtaskgang_framework.SearchResults(Thread.currentThread().getId(),
                              currentCycle(),
                              word,
                              inputData);
