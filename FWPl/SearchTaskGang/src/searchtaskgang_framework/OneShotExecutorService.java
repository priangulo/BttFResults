 ...
 */
public class OneShotExecutorService extends searchtaskgang_framework.SearchTaskGangCommon {
    /**
     ...
     */
     public BlockingQueue<searchtaskgang_framework.SearchResults> mResultsQueue = 
        new LinkedBlockingQueue<searchtaskgang_framework.SearchResults>();
     ...
     * background Thread.
     */
    protected void queueResults(searchtaskgang_framework.SearchResults results) {
     ...
     */
    protected BlockingQueue<searchtaskgang_framework.SearchResults> setQueue(BlockingQueue<searchtaskgang_framework.SearchResults> q) {
        BlockingQueue<searchtaskgang_framework.SearchResults> old = mResultsQueue;
        mResultsQueue = q;
        return old;
    }
     ...
     */
    protected BlockingQueue<searchtaskgang_framework.SearchResults> getQueue() {
