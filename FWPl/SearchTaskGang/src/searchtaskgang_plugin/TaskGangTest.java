...
public class TaskGangTest {
    ...
    private static Runnable makeTaskGang(String[] wordList,
        ...
        case ONESHOT_THREAD_PER_TASK:
            return new searchtaskgang_framework.OneShotThreadPerTask(wordList,
                                            mOneShotInputStrings);
        case ONESHOT_EXECUTOR_SERVICE:
            return new searchtaskgang_framework.OneShotExecutorService(wordList,
                                              mOneShotInputStrings);
        case ONESHOT_EXECUTOR_SERVICE_FUTURE:
            return new searchtaskgang_framework.OneShotExecutorServiceFuture(wordList,
                                                    mOneShotInputStrings);
        case ONESHOT_EXECUTOR_COMPLETION_SERVICE:
            return new searchtaskgang_framework.OneShotExecutorCompletionService(wordList,
                                                        mOneShotInputStrings);
        }
        return null;
    }
