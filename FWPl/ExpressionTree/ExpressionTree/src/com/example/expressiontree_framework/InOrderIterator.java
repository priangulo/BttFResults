 ...
 */
public class InOrderIterator implements Iterator<com.example.expressiontree_framework.ExpressionTree> {
    /** Stack of trees. */
    ...
    /** Ctor */
    public InOrderIterator(com.example.expressiontree_framework.ExpressionTree tree) {
        if(!tree.isNull()) {
            stack.push(tree);
