 ...
 */
public class SuccinctModeInputHandler extends com.example.expressiontree_plugin.InputHandler {
    /** This hook method succinctly prompts the user for input. */
    public void promptUser() {
        if (com.example.expressiontree_framework.Platform.instance().isCommandLinePlatform())
            com.example.expressiontree_framework.Platform.instance().outputString("> ");
    }
     ...
     */
    public com.example.expressiontree_framework.UserCommand makeUserCommand(String userInputExpression) {
        /**
